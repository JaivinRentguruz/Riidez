...
abstract class AcuantBaseCameraFragment : Fragment() {
    ...
    private fun requestCameraPermission() {
        if (shouldShowRequestPermissionRationale(Manifest.permission.CAMERA)) {
            ConfirmationDialog().onCreateDialog(null).show()
            //childFragmentManager, FRAGMENT_DIALOG
        } else {
    ...
    override fun onRequestPermissionsResult(requestCode: Int,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.size != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance(getString(R.string.request_permission)).onCreateDialog(null).show()
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        ...
        try {
            ...
            ErrorDialog.newInstance(getString(R.string.acuant_camera_error)).onCreateDialog(null).show()
