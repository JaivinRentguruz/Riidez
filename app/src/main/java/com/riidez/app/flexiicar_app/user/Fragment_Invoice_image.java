...
public class Fragment_Invoice_image extends Fragment
{
    ImageView backarrow;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_invoice_image, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            backarrow = view.findViewById(R.id.back_invoiceimg);
            web_view = view.findViewById(R.id.webview2);
            Payment_Total = view.findViewById(R.id.Payment_Total3);
            txt_CardNo = view.findViewById(R.id.txtCard_No);
            txt_CardExDate = view.findViewById(R.id.Card_ExDate);
            lblPay = view.findViewById(R.id.Layout_PAy);
            llforPaid=view.findViewById(R.id.llForPaidInvoice);
            llForUnpaid=view.findViewById(R.id.llForUnpaidInvoice);
            txt_Payment_Status=view.findViewById(R.id.PaymentStatusForInvoice);
            Payment_TotalAmount=view.findViewById(R.id.Invoice_TotalAmount);
           ...
           // String url1 = serverpath + pdfFileName;
            ...
            TextView changeCreditCard = view.findViewById(R.id.changeCCInvoiceImage);
            changeCreditCard.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Invoice_image.this)
                            .navigate(R.id.action_Invoice_Image_to_CardsOnAccount, bundle);
                }
            });
            backarrow.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Invoice_image.this)
                            .navigate(R.id.action_Invoice_Image_to_Bills_and_Payment,bundle);
                }
            });
            String bodyParam1 = "";
            try
                    ...
                    try {
                        ...
                        if (status)
                        {
                            try
                            {
                                ...
                                NavHostFragment.findNavController(Fragment_Invoice_image.this)
                                        .navigate(R.id.action_Invoice_Image_to_Payment_Success, paymentBundle);
                            }
                            catch (Exception e)
                            {
                                e.printStackTrace();
