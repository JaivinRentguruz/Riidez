        ...
        try {
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_7.this)
                            .navigate(R.id.action_Vehicle_Image_7_to_VehImage_SelfCheckIn_8, SelfCheckInBundle);
                }
            });
            imgback.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    System.out.println(SelfCheckInBundle);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_7.this)
                            .navigate(R.id.action_VehImage_SelfCheckIn_7_to_VehImage_SelfCheckIn_6,SelfCheckInBundle);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_7.this)
                                            .navigate(R.id.action_VehImage_SelfCheckIn_7_to_User_Details);
                                }
                            });
