...
public class Fragment_Vehicle_Image_10 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try{
            ...
            {
                final String image1 = ((JSONObject) (ImageList.get(9))).getString("fileBase64");
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_10.this)
                            .navigate(R.id.action_Vehicle_Image_10_to_Vehicle_Additional_image, Agreements);
                }
            });
            imgback.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    System.out.println(Agreements);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_10.this)
                            .navigate(R.id.action_Vehicle_Image_10_to_Vehicle_Image_9,Agreements);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_10.this)
                                            .navigate(R.id.action_Vehicle_Image_10_to_User_Details);
                                }
                            });
