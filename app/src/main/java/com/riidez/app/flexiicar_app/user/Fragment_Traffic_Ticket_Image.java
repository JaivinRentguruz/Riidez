...
public class Fragment_Traffic_Ticket_Image  extends Fragment
{
    ImageView backarrow;
    String serverpath="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_traffic_ticket_image, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try{
            backarrow=view.findViewById(R.id.back_traffic_ticketimg);
            web_view =  view.findViewById(R.id.webview1);
            Payment_Total = view.findViewById(R.id.Payment_Total2);

            txt_CardNo=view.findViewById(R.id.txt_Card_no);
            txt_CardExDate=view.findViewById(R.id.txt_Card_ExDate);
            lblPay=view.findViewById(R.id.Layout_Payment);
            llforPaid=view.findViewById(R.id.llForPaid1);
            llForUnpaid=view.findViewById(R.id.llForUnpaid1);
            ...
            txt_Payment_Status=view.findViewById(R.id.txt_Payment_Status1);
            Payment_TotalAmount=view.findViewById(R.id.traffic_TotalAmount);
            ...
            String url1 = serverpath + pdfFileName.substring(2);
           // String url1 = serverpath + pdfFileName;
            ...
            TextView changeCreditCard = view.findViewById(R.id.changeCardTrafficTicket);
            changeCreditCard.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Traffic_Ticket_Image.this)
                            .navigate(R.id.action_Traffic_Ticket_Image_to_CardsOnAccount, bundle);
                }
            });
            backarrow.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Traffic_Ticket_Image.this)
                            .navigate(R.id.action_Traffic_Ticket_Image_to_Bills_and_Payment,bundle);
                }
            });
            String bodyParam1 = "";
            try
                    ...
                    try {
                        ...
                        if (status)
                        {
                            try
                            {
                                ...
                                NavHostFragment.findNavController(Fragment_Traffic_Ticket_Image.this)
                                        .navigate(R.id.action_Traffic_Ticket_Image_to_Payment_Success, paymentBundle);
                            }
                            catch (Exception e)
                            {
                                e.printStackTrace();
