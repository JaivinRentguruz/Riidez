...
public class Fragment_Vehicle_Image_2 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            ...
            {
                final String image1 = ((JSONObject) (ImageList.get(1))).getString("fileBase64");
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_2.this)
                            .navigate(R.id.action_Vehicle_img_2_to_Vehicle_Image_3, Agreements);
                }
            });
            ...
            imgback.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    Bundle Agreements = new Bundle();
                    Agreements.putBundle("AgreementsBundle", AgreementsBundle);
                    Agreements.putBoolean("BackTo",true);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_2.this)
                            .navigate(R.id.action_Vehicle_img_2_to_Vehicle_Image_1, Agreements);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_2.this)
                                            .navigate(R.id.action_Vehicle_img_2_to_User_Details);
                                }
                            });
