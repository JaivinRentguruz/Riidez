...
public class Fragment_Vehicle_Image_7 extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_vehicle_images_7, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            ...
            DateTime=view.findViewById(R.id.txt_DateTimeVehImg7);
            ...
            UploadImg=view.findViewById(R.id.Image_Upload7);
            ...
            {
                final String image1 = ((JSONObject) (ImageList.get(6))).getString("fileBase64");
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_7.this)
                            .navigate(R.id.action_Vehicle_Image_7_to_Vehicle_Image_8, Agreements);
                }
            });
            imgback.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    System.out.println(Agreements);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_7.this)
                            .navigate(R.id.action_Vehicle_Image_7_to_Vehicle_Image_6,Agreements);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_7.this)
                                            .navigate(R.id.action_Vehicle_Image_7_to_User_Details);
                                }
                            });
