...
public class Fragment_Vehicle_Image_9 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            ...
            {
                final String image1 = ((JSONObject) (ImageList.get(8))).getString("fileBase64");
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_9.this)
                            .navigate(R.id.action_VehImage_SelfCheckIn_9_to_VehImage_SelfCheckIn_10, SelfCheckInBundle);
                }
            });
            imgback.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    System.out.println(SelfCheckInBundle);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_9.this)
                            .navigate(R.id.action_VehImage_SelfCheckIn_9_to_VehImage_SelfCheckIn_8,SelfCheckInBundle);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_9.this)
                                            .navigate(R.id.action_VehImage_SelfCheckIn_9_to_User_Details);
                                }
                            });
