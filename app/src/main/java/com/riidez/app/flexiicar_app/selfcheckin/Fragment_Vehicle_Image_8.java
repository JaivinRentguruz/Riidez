...
public class Fragment_Vehicle_Image_8 extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_vehicle_images_8, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            DateTime=view.findViewById(R.id.txt_DateTimeVehImg8);
            ...
            UploadImg=view.findViewById(R.id.Image_Upload8);
            ...
            {
                final String image1 = ((JSONObject) (ImageList.get(7))).getString("fileBase64");
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_8.this)
                            .navigate(R.id.action_VehImage_SelfCheckIn_8_to_VehImage_SelfCheckIn_9, SelfCheckInBundle);
                }
            });
            imgback.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    System.out.println(SelfCheckInBundle);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_8.this)
                            .navigate(R.id.action_VehImage_SelfCheckIn_8_VehImage_SelfCheckIn_7,SelfCheckInBundle);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_8.this)
                                            .navigate(R.id.action_VehImage_SelfCheckIn_8_to_User_Details);
                                }
                            });
