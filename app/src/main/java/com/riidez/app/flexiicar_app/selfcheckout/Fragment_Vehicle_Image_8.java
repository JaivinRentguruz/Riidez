...
public class Fragment_Vehicle_Image_8 extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            ...
            txtDiscard = view.findViewById(R.id.lbl_Discard);
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v) {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_8.this)
                            .navigate(R.id.action_Vehicle_Image_8_to_Vehicle_Image_9, Agreements);
                }
            });
            imgback.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    System.out.println(Agreements);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_8.this)
                            .navigate(R.id.action_Vehicle_Image_8_to_Vehicle_Image_7, Agreements);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_8.this)
                                            .navigate(R.id.action_Vehicle_Image_8_to_User_Details);
                                }
                            });
