...
public class Fragment_Vehicle_Image_3 extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_vehicle_images_3, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        try {
            DateTime=view.findViewById(R.id.txt_DateTimeVehImg3);
            ...
            UploadImg=view.findViewById(R.id.DriverSideImage);
            ...
            {
                final String image1 = ((JSONObject) (ImageList.get(2))).getString("fileBase64");
            ...
            lblNext.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_3.this)
                            .navigate(R.id.action_VehImage_SelfCheckIn_3_to_VehImage_SelfCheckIn_4, SelfCheckInBundle);
                }
            });
            imgback.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    System.out.println(SelfCheckInBundle);
                    NavHostFragment.findNavController(Fragment_Vehicle_Image_3.this)
                            .navigate(R.id.action_VehImage_SelfCheckIn_3_to_VehImage_SelfCheckIn_2,SelfCheckInBundle);
                }
            });
                ...
                public void onClick(View view)
                {
                    ...
                    builder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    NavHostFragment.findNavController(Fragment_Vehicle_Image_3.this)
                                            .navigate(R.id.action_VehImage_SelfCheckIn_3_to_User_Details);
                                }
                            });
