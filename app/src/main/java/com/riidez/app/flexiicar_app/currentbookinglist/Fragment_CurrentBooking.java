...
import com.riidez.app.flexiicar_app.user.Fragment_Agreements;
...
public class Fragment_CurrentBooking extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(Fragment_CurrentBooking.this).popBackStack();
            }
        });
                                ...
                                linearLayout.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                     /*   Intent i = new Intent(getContext(), Booking_Activity.class);
                                        ...
                                        NavHostFragment.findNavController(Fragment_CurrentBooking.this)
                                                .navigate(R.id.action_BookingList_to_LocationAndKey,bundle);
